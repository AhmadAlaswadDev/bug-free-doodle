...
class MyTheme{
  ...
  static Color accent_color = Color.fromRGBO(0, 188, 205, 1);
  static Color accent_color_shadow = Color.fromRGBO(134, 213, 227, 1); // this color is a dropshadow of
  static Color soft_accent_color = Color.fromRGBO(254,234,209, 1);
  static Color splash_screen_color = Color.fromRGBO(29, 193, 221, 1); // if not sure , use the same color as accent color
